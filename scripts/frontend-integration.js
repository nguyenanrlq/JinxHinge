 ...
 * This file demonstrates how to integrate Jinxhinge with a web frontend
 */

// For React/Vue/Angular applications
export class JinxhingeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new JinxhingeClient(provider, contractAddress);
